...
/**
 * The persistent class for the sr_ms_glabn database table.
 * 
 */
//@Entity
@Table(name="sr_ms_glabn")
@NamedQuery(name="SrMsGlabn.findAll", query="SELECT s FROM SrMsGlabn s")
public class SrMsGlabn implements Serializable {
	...
	public BigDecimal getMsnDrw() {
		return this.msnDrw;
	}

	public void setMsnDrw(BigDecimal msnDrw) {
		this.msnDrw = msnDrw;
	}
