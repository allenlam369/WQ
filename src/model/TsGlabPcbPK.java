...
/**
 * The primary key class for the ts_glab_pcb database table.
 * 
 */
@Embeddable
public class TsGlabPcbPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TsGlabPcbPK)) {
			return false;
		}
		TsGlabPcbPK castOther = (TsGlabPcbPK)other;
		return 
