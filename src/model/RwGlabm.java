...
/**
 * The persistent class for the rw_glabm database table.
 * 
 */
@Entity
@Table(name="rw_glabm")
@NamedQuery(name="RwGlabm.findAll", query="SELECT r FROM RwGlabm r")
public class RwGlabm implements Serializable {
