...
/**
 * The primary key class for the tb_clab_oc database table.
 * 
 */
@Embeddable
public class TbClabOcPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TbClabOcPK)) {
			return false;
		}
		TbClabOcPK castOther = (TbClabOcPK)other;
		return 
