...
/**
 * The persistent class for the sr_mw_glabn database table.
 * 
 */
//@Entity
@Table(name="sr_mw_glabn")
@NamedQuery(name="SrMwGlabn.findAll", query="SELECT s FROM SrMwGlabn s")
public class SrMwGlabn implements Serializable {
