...
/**
 * The persistent class for the view_river_1 database table.
 * 
 */
//@Entity
@Table(name="view_river_1")
@NamedQuery(name="ViewRiver1.findAll", query="SELECT v FROM ViewRiver1 v")
public class ViewRiver1 implements Serializable {
	...
	@Column(name="ph_field")
	private BigDecimal phField;
	...
	public BigDecimal getPhField() {
		return this.phField;
	}

	public void setPhField(BigDecimal phField) {
		this.phField = phField;
	}
