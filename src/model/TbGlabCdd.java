...
/**
 * The persistent class for the tb_glab_cdd database table.
 * 
 */
@Entity
@Table(name="tb_glab_cdd")
@NamedQuery(name="TbGlabCdd.findAll", query="SELECT t FROM TbGlabCdd t")
public class TbGlabCdd implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TbGlabCddPK id;
	...
	public TbGlabCddPK getId() {
		return this.id;
	}

	public void setId(TbGlabCddPK id) {
		this.id = id;
	}
