...
/**
 * The persistent class for the marine_water_statistics10a1 database table.
 * 
 */
//@Entity
@Table(name="marine_water_statistics10a1")
@NamedQuery(name="MarineWaterStatistics10a1.findAll", query="SELECT m FROM MarineWaterStatistics10a1 m")
public class MarineWaterStatistics10a1 implements Serializable {
	...
	public MarineWaterStatistics10a1() {
	}
