...
/**
 * The persistent class for the dioxin_sediment2 database table.
 * 
 */
//@Entity
@Table(name="dioxin_sediment2")
@NamedQuery(name="DioxinSediment2.findAll", query="SELECT d FROM DioxinSediment2 d")
public class DioxinSediment2 implements Serializable {
