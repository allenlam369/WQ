...
/**
 * The persistent class for the ts_glab_pah database table.
 * 
 */
@Entity
@Table(name="ts_glab_pah")
@NamedQuery(name="TsGlabPah.findAll", query="SELECT t FROM TsGlabPah t")
public class TsGlabPah implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TsGlabPahPK id;
	...
	public TsGlabPahPK getId() {
		return this.id;
	}

	public void setId(TsGlabPahPK id) {
		this.id = id;
	}
