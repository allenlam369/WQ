...
/**
 * The persistent class for the river_water_avg1 database table.
 * 
 */
//@Entity
@Table(name="river_water_avg1")
@NamedQuery(name="RiverWaterAvg1.findAll", query="SELECT r FROM RiverWaterAvg1 r")
public class RiverWaterAvg1 implements Serializable {
