...
/**
 * The persistent class for the ts_glab_pcb_cal database table.
 * 
 */
//@Entity
@Table(name="ts_glab_pcb_cal")
@NamedQuery(name="TsGlabPcbCal.findAll", query="SELECT t FROM TsGlabPcbCal t")
public class TsGlabPcbCal implements Serializable {
