...
/**
 * The persistent class for the sr_ms_ps database table.
 * 
 */
//@Entity
@Table(name="sr_ms_ps")
@NamedQuery(name="SrMsP.findAll", query="SELECT s FROM SrMsP s")
public class SrMsP implements Serializable {
