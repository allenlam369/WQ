...
/**
 * The persistent class for the tb_glab_oc_cal database table.
 * 
 */
//@Entity
@Table(name="tb_glab_oc_cal")
@NamedQuery(name="TbGlabOcCal.findAll", query="SELECT t FROM TbGlabOcCal t")
public class TbGlabOcCal implements Serializable {
