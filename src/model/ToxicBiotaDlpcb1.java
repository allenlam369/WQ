...
/**
 * The persistent class for the toxic_biota_dlpcb1 database table.
 * 
 */
//@Entity
@Table(name="toxic_biota_dlpcb1")
@NamedQuery(name="ToxicBiotaDlpcb1.findAll", query="SELECT t FROM ToxicBiotaDlpcb1 t")
public class ToxicBiotaDlpcb1 implements Serializable {
