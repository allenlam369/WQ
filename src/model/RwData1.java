...
/**
 * The persistent class for the rw_data1 database table.
 * 
 */
//@Entity
@Table(name="rw_data1")
@NamedQuery(name="RwData1.findAll", query="SELECT r FROM RwData1 r")
public class RwData1 implements Serializable {
