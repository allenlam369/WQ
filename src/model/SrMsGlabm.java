...
/**
 * The persistent class for the sr_ms_glabm database table.
 * 
 */
//@Entity
@Table(name="sr_ms_glabm")
@NamedQuery(name="SrMsGlabm.findAll", query="SELECT s FROM SrMsGlabm s")
public class SrMsGlabm implements Serializable {
