...
/**
 * The persistent class for the sr_rw_glabn database table.
 * 
 */
//@Entity
@Table(name="sr_rw_glabn")
@NamedQuery(name="SrRwGlabn.findAll", query="SELECT s FROM SrRwGlabn s")
public class SrRwGlabn implements Serializable {
