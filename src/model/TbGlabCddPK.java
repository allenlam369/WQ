...
/**
 * The primary key class for the tb_glab_cdd database table.
 * 
 */
@Embeddable
public class TbGlabCddPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TbGlabCddPK)) {
			return false;
		}
		TbGlabCddPK castOther = (TbGlabCddPK)other;
		return 
