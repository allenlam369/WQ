...
/**
 * The persistent class for the sr_rw_statistics10a database table.
 * 
 */
//@Entity
@Table(name="sr_rw_statistics10a")
@NamedQuery(name="SrRwStatistics10a.findAll", query="SELECT s FROM SrRwStatistics10a s")
public class SrRwStatistics10a implements Serializable {
