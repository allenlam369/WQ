...
/**
 * The persistent class for the tw_clab_cdd database table.
 * 
 */
@Entity
@Table(name="tw_clab_cdd")
@NamedQuery(name="TwClabCdd.findAll", query="SELECT t FROM TwClabCdd t")
public class TwClabCdd implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TwClabCddPK id;
	...
	public TwClabCddPK getId() {
		return this.id;
	}

	public void setId(TwClabCddPK id) {
		this.id = id;
	}
