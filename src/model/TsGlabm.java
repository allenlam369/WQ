...
/**
 * The persistent class for the ts_glabm database table.
 * 
 */
@Entity
@Table(name="ts_glabm")
@NamedQuery(name="TsGlabm.findAll", query="SELECT t FROM TsGlabm t")
public class TsGlabm implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TsGlabmPK id;
	...
	public TsGlabmPK getId() {
		return this.id;
	}

	public void setId(TsGlabmPK id) {
		this.id = id;
	}
