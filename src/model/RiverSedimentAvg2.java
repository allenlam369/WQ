...
/**
 * The persistent class for the river_sediment_avg2 database table.
 * 
 */
//@Entity
@Table(name="river_sediment_avg2")
@NamedQuery(name="RiverSedimentAvg2.findAll", query="SELECT r FROM RiverSedimentAvg2 r")
public class RiverSedimentAvg2 implements Serializable {
