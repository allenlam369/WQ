...
/**
 * The persistent class for the river_water_statistics database table.
 * 
 */
//@Entity
@Table(name="river_water_statistics")
@NamedQuery(name="RiverWaterStatistic.findAll", query="SELECT r FROM RiverWaterStatistic r")
public class RiverWaterStatistic implements Serializable {
