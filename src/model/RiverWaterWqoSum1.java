...
/**
 * The persistent class for the river_water_wqo_sum1 database table.
 * 
 */
//@Entity
@Table(name="river_water_wqo_sum1")
@NamedQuery(name="RiverWaterWqoSum1.findAll", query="SELECT r FROM RiverWaterWqoSum1 r")
public class RiverWaterWqoSum1 implements Serializable {
