...
/**
 * The persistent class for the toxic_sediment_cdd1 database table.
 * 
 */
//@Entity
@Table(name="toxic_sediment_cdd1")
@NamedQuery(name="ToxicSedimentCdd1.findAll", query="SELECT t FROM ToxicSedimentCdd1 t")
public class ToxicSedimentCdd1 implements Serializable {
