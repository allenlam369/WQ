...
/**
 * The primary key class for the tb_clab_pah database table.
 * 
 */
@Embeddable
public class TbClabPahPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TbClabPahPK)) {
			return false;
		}
		TbClabPahPK castOther = (TbClabPahPK)other;
		return 
