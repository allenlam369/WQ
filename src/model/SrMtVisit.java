...
/**
 * The persistent class for the sr_mt_visit database table.
 * 
 */
//@Entity
@Table(name="sr_mt_visit")
@NamedQuery(name="SrMtVisit.findAll", query="SELECT s FROM SrMtVisit s")
public class SrMtVisit implements Serializable {
