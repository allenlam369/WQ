...
/**
 * The persistent class for the tw_glab_oc_cal database table.
 * 
 */
//@Entity
@Table(name="tw_glab_oc_cal")
@NamedQuery(name="TwGlabOcCal.findAll", query="SELECT t FROM TwGlabOcCal t")
public class TwGlabOcCal implements Serializable {
