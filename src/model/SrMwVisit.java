...
/**
 * The persistent class for the sr_mw_visit database table.
 * 
 */
//@Entity
@Table(name="sr_mw_visit")
@NamedQuery(name="SrMwVisit.findAll", query="SELECT s FROM SrMwVisit s")
public class SrMwVisit implements Serializable {
