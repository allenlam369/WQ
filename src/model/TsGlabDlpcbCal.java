...
/**
 * The persistent class for the ts_glab_dlpcb_cal database table.
 * 
 */
//@Entity
@Table(name="ts_glab_dlpcb_cal")
@NamedQuery(name="TsGlabDlpcbCal.findAll", query="SELECT t FROM TsGlabDlpcbCal t")
public class TsGlabDlpcbCal implements Serializable {
