...
/**
 * The primary key class for the tb_glab_pcb database table.
 * 
 */
@Embeddable
public class TbGlabPcbPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TbGlabPcbPK)) {
			return false;
		}
		TbGlabPcbPK castOther = (TbGlabPcbPK)other;
		return 
