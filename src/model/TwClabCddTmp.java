...
/**
 * The persistent class for the tw_clab_cdd_tmp database table.
 * 
 */
//@Entity
@Table(name="tw_clab_cdd_tmp")
@NamedQuery(name="TwClabCddTmp.findAll", query="SELECT t FROM TwClabCddTmp t")
public class TwClabCddTmp implements Serializable {
