...
/**
 * The primary key class for the tw_clab_bu database table.
 * 
 */
@Embeddable
public class TwClabBuPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TwClabBuPK)) {
			return false;
		}
		TwClabBuPK castOther = (TwClabBuPK)other;
		return 
