...
/**
 * The persistent class for the tw_clab_cdd_cal database table.
 * 
 */
//@Entity
@Table(name="tw_clab_cdd_cal")
@NamedQuery(name="TwClabCddCal.findAll", query="SELECT t FROM TwClabCddCal t")
public class TwClabCddCal implements Serializable {
