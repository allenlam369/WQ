...
/**
 * The persistent class for the toxic_water_pbde1 database table.
 * 
 */
//@Entity
@Table(name="toxic_water_pbde1")
@NamedQuery(name="ToxicWaterPbde1.findAll", query="SELECT t FROM ToxicWaterPbde1 t")
public class ToxicWaterPbde1 implements Serializable {
