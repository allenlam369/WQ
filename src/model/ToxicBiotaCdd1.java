...
/**
 * The persistent class for the toxic_biota_cdd1 database table.
 * 
 */
//@Entity
@Table(name="toxic_biota_cdd1")
@NamedQuery(name="ToxicBiotaCdd1.findAll", query="SELECT t FROM ToxicBiotaCdd1 t")
public class ToxicBiotaCdd1 implements Serializable {
