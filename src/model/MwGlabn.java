...
/**
 * The persistent class for the mw_glabn database table.
 * 
 */
@Entity
@Table(name="mw_glabn")
@NamedQuery(name="MwGlabn.findAll", query="SELECT m FROM MwGlabn m")
public class MwGlabn implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MwGlabnPK id;
	...
	public MwGlabnPK getId() {
		return this.id;
	}

	public void setId(MwGlabnPK id) {
		this.id = id;
	}
