...
/**
 * The primary key class for the tb_clab_cdd database table.
 * 
 */
@Embeddable
public class TbClabCddPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TbClabCddPK)) {
			return false;
		}
		TbClabCddPK castOther = (TbClabCddPK)other;
		return 
