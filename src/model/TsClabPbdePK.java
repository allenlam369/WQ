...
/**
 * The primary key class for the ts_clab_pbde database table.
 * 
 */
@Embeddable
public class TsClabPbdePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TsClabPbdePK)) {
			return false;
		}
		TsClabPbdePK castOther = (TsClabPbdePK)other;
		return 
