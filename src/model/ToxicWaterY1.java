...
/**
 * The persistent class for the toxic_water_y1 database table.
 * 
 */
//@Entity
@Table(name="toxic_water_y1")
@NamedQuery(name="ToxicWaterY1.findAll", query="SELECT t FROM ToxicWaterY1 t")
public class ToxicWaterY1 implements Serializable {
