...
/**
 * The persistent class for the hs_glabn_cal database table.
 * 
 */
//@Entity
@Table(name="hs_glabn_cal")
@NamedQuery(name="HsGlabnCal.findAll", query="SELECT h FROM HsGlabnCal h")
public class HsGlabnCal implements Serializable {
