...
/**
 * The primary key class for the ms_glabo database table.
 * 
 */
@Embeddable
public class MsGlaboPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MsGlaboPK)) {
			return false;
		}
		MsGlaboPK castOther = (MsGlaboPK)other;
		return 
