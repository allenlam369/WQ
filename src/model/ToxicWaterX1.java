...
/**
 * The persistent class for the toxic_water_x1 database table.
 * 
 */
//@Entity
@Table(name="toxic_water_x1")
@NamedQuery(name="ToxicWaterX1.findAll", query="SELECT t FROM ToxicWaterX1 t")
public class ToxicWaterX1 implements Serializable {
