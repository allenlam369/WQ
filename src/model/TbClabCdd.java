...
/**
 * The persistent class for the tb_clab_cdd database table.
 * 
 */
@Entity
@Table(name="tb_clab_cdd")
@NamedQuery(name="TbClabCdd.findAll", query="SELECT t FROM TbClabCdd t")
public class TbClabCdd implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TbClabCddPK id;
	...
	public TbClabCddPK getId() {
		return this.id;
	}

	public void setId(TbClabCddPK id) {
		this.id = id;
	}
