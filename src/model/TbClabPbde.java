...
/**
 * The persistent class for the tb_clab_pbde database table.
 * 
 */
@Entity
@Table(name="tb_clab_pbde")
@NamedQuery(name="TbClabPbde.findAll", query="SELECT t FROM TbClabPbde t")
public class TbClabPbde implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TbClabPbdePK id;
	...
	public TbClabPbdePK getId() {
		return this.id;
	}

	public void setId(TbClabPbdePK id) {
		this.id = id;
	}
