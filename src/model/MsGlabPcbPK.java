...
/**
 * The primary key class for the ms_glab_pcb database table.
 * 
 */
@Embeddable
public class MsGlabPcbPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MsGlabPcbPK)) {
			return false;
		}
		MsGlabPcbPK castOther = (MsGlabPcbPK)other;
		return 
