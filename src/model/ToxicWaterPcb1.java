...
/**
 * The persistent class for the toxic_water_pcb1 database table.
 * 
 */
//@Entity
@Table(name="toxic_water_pcb1")
@NamedQuery(name="ToxicWaterPcb1.findAll", query="SELECT t FROM ToxicWaterPcb1 t")
public class ToxicWaterPcb1 implements Serializable {
