...
/**
 * The persistent class for the hs_mlab database table.
 * 
 */
@Entity
@Table(name="hs_mlab")
@NamedQuery(name="HsMlab.findAll", query="SELECT h FROM HsMlab h")
public class HsMlab implements Serializable {
	...
	public HsMlabPK getId() {
		return this.id;
	}

	public void setId(HsMlabPK id) {
		this.id = id;
	}
