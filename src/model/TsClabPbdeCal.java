...
/**
 * The persistent class for the ts_clab_pbde_cal database table.
 * 
 */
//@Entity
@Table(name="ts_clab_pbde_cal")
@NamedQuery(name="TsClabPbdeCal.findAll", query="SELECT t FROM TsClabPbdeCal t")
public class TsClabPbdeCal implements Serializable {
