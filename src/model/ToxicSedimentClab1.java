...
/**
 * The persistent class for the toxic_sediment_clab1 database table.
 * 
 */
//@Entity
@Table(name="toxic_sediment_clab1")
@NamedQuery(name="ToxicSedimentClab1.findAll", query="SELECT t FROM ToxicSedimentClab1 t")
public class ToxicSedimentClab1 implements Serializable {
