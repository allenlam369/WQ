...
/**
 * The persistent class for the hs_glabn_cal_aa database table.
 * 
 */
//@Entity
@Table(name="hs_glabn_cal_aa")
@NamedQuery(name="HsGlabnCalAa.findAll", query="SELECT h FROM HsGlabnCalAa h")
public class HsGlabnCalAa implements Serializable {
