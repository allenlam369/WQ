...
/**
 * The persistent class for the rw_glabn database table.
 * 
 */
@Entity
@Table(name="rw_glabn")
@NamedQuery(name="RwGlabn.findAll", query="SELECT r FROM RwGlabn r")
public class RwGlabn implements Serializable {
