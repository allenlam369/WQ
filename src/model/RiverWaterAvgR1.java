...
/**
 * The persistent class for the river_water_avg_r1 database table.
 * 
 */
//@Entity
@Table(name="river_water_avg_r1")
@NamedQuery(name="RiverWaterAvgR1.findAll", query="SELECT r FROM RiverWaterAvgR1 r")
public class RiverWaterAvgR1 implements Serializable {
