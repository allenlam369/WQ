...
/**
 * The persistent class for the hats_2a_wqo_raw1 database table.
 * 
 */
//@Entity
@Table(name="hats_2a_wqo_raw1")
@NamedQuery(name="Hats2aWqoRaw1.findAll", query="SELECT h FROM Hats2aWqoRaw1 h")
public class Hats2aWqoRaw1 implements Serializable {
