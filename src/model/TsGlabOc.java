...
/**
 * The persistent class for the ts_glab_oc database table.
 * 
 */
@Entity
@Table(name="ts_glab_oc")
@NamedQuery(name="TsGlabOc.findAll", query="SELECT t FROM TsGlabOc t")
public class TsGlabOc implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TsGlabOcPK id;
	...
	public TsGlabOcPK getId() {
		return this.id;
	}

	public void setId(TsGlabOcPK id) {
		this.id = id;
	}
