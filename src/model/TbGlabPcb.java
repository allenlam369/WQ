...
/**
 * The persistent class for the tb_glab_pcb database table.
 * 
 */
@Entity
@Table(name="tb_glab_pcb")
@NamedQuery(name="TbGlabPcb.findAll", query="SELECT t FROM TbGlabPcb t")
public class TbGlabPcb implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TbGlabPcbPK id;
	...
	public TbGlabPcbPK getId() {
		return this.id;
	}

	public void setId(TbGlabPcbPK id) {
		this.id = id;
	}
