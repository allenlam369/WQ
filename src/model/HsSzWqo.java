...
/**
 * The persistent class for the hs_sz_wqo database table.
 * 
 */
@Entity
@Table(name="hs_sz_wqo")
@NamedQuery(name="HsSzWqo.findAll", query="SELECT h FROM HsSzWqo h")
public class HsSzWqo implements Serializable {
