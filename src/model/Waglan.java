...
/**
 * The persistent class for the waglan database table.
 * 
 */
//@Entity
@NamedQuery(name="Waglan.findAll", query="SELECT w FROM Waglan w")
public class Waglan implements Serializable {
