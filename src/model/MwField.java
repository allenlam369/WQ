...
/**
 * The persistent class for the mw_field database table.
 * 
 */
@Entity
@Table(name="mw_field")
@NamedQuery(name="MwField.findAll", query="SELECT m FROM MwField m")
public class MwField implements Serializable {
