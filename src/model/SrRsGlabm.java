...
/**
 * The persistent class for the sr_rs_glabm database table.
 * 
 */
//@Entity
@Table(name="sr_rs_glabm")
@NamedQuery(name="SrRsGlabm.findAll", query="SELECT s FROM SrRsGlabm s")
public class SrRsGlabm implements Serializable {
