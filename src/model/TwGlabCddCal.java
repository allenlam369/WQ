...
/**
 * The persistent class for the tw_glab_cdd_cal database table.
 * 
 */
//@Entity
@Table(name="tw_glab_cdd_cal")
@NamedQuery(name="TwGlabCddCal.findAll", query="SELECT t FROM TwGlabCddCal t")
public class TwGlabCddCal implements Serializable {
