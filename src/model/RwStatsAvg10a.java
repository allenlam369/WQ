...
/**
 * The persistent class for the rw_stats_avg10a database table.
 * 
 */
//@Entity
@Table(name="rw_stats_avg10a")
@NamedQuery(name="RwStatsAvg10a.findAll", query="SELECT r FROM RwStatsAvg10a r")
public class RwStatsAvg10a implements Serializable {
