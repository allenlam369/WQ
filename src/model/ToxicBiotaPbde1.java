...
/**
 * The persistent class for the toxic_biota_pbde1 database table.
 * 
 */
//@Entity
@Table(name="toxic_biota_pbde1")
@NamedQuery(name="ToxicBiotaPbde1.findAll", query="SELECT t FROM ToxicBiotaPbde1 t")
public class ToxicBiotaPbde1 implements Serializable {
