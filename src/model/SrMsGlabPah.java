...
/**
 * The persistent class for the sr_ms_glab_pah database table.
 * 
 */
//@Entity
@Table(name="sr_ms_glab_pah")
@NamedQuery(name="SrMsGlabPah.findAll", query="SELECT s FROM SrMsGlabPah s")
public class SrMsGlabPah implements Serializable {
