...
/**
 * The primary key class for the mw_glabn_e database table.
 * 
 */
@Embeddable
public class MwGlabnEPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MwGlabnEPK)) {
			return false;
		}
		MwGlabnEPK castOther = (MwGlabnEPK)other;
		return 
