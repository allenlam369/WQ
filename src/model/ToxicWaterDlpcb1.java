...
/**
 * The persistent class for the toxic_water_dlpcb1 database table.
 * 
 */
//@Entity
@Table(name="toxic_water_dlpcb1")
@NamedQuery(name="ToxicWaterDlpcb1.findAll", query="SELECT t FROM ToxicWaterDlpcb1 t")
public class ToxicWaterDlpcb1 implements Serializable {
