...
/**
 * The primary key class for the tw_glab_pah database table.
 * 
 */
@Embeddable
public class TwGlabPahPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TwGlabPahPK)) {
			return false;
		}
		TwGlabPahPK castOther = (TwGlabPahPK)other;
		return 
