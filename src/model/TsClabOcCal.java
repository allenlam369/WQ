...
/**
 * The persistent class for the ts_clab_oc_cal database table.
 * 
 */
//@Entity
@Table(name="ts_clab_oc_cal")
@NamedQuery(name="TsClabOcCal.findAll", query="SELECT t FROM TsClabOcCal t")
public class TsClabOcCal implements Serializable {
	...
	@Column(name="tox_p26")
	private String toxP26;

	@Column(name="tox_p50")
	private String toxP50;

	@Column(name="tox_p62")
	private String toxP62;
	...
	public String getKepone() {
		return this.kepone;
	}

	public void setKepone(String kepone) {
		this.kepone = kepone;
	}
	...
	public String getPecb() {
		return this.pecb;
	}

	public void setPecb(String pecb) {
		this.pecb = pecb;
	}
	...
	public String getToxP26() {
		return this.toxP26;
	}

	public void setToxP26(String toxP26) {
		this.toxP26 = toxP26;
	}

	public String getToxP50() {
		return this.toxP50;
	}

	public void setToxP50(String toxP50) {
		this.toxP50 = toxP50;
	}

	public String getToxP62() {
		return this.toxP62;
	}

	public void setToxP62(String toxP62) {
		this.toxP62 = toxP62;
	}
