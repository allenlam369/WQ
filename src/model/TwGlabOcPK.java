...
/**
 * The primary key class for the tw_glab_oc database table.
 * 
 */
@Embeddable
public class TwGlabOcPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TwGlabOcPK)) {
			return false;
		}
		TwGlabOcPK castOther = (TwGlabOcPK)other;
		return 
