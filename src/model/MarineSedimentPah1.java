...
/**
 * The persistent class for the marine_sediment_pah1 database table.
 * 
 */
//@Entity
@Table(name="marine_sediment_pah1")
@NamedQuery(name="MarineSedimentPah1.findAll", query="SELECT m FROM MarineSedimentPah1 m")
public class MarineSedimentPah1 implements Serializable {
