...
/**
 * The persistent class for the tb_clab_oc database table.
 * 
 */
@Entity
@Table(name="tb_clab_oc")
@NamedQuery(name="TbClabOc.findAll", query="SELECT t FROM TbClabOc t")
public class TbClabOc implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TbClabOcPK id;
	...
	public TbClabOcPK getId() {
		return this.id;
	}

	public void setId(TbClabOcPK id) {
		this.id = id;
	}
