...
/**
 * The persistent class for the river_water_avg2 database table.
 * 
 */
//@Entity
@Table(name="river_water_avg2")
@NamedQuery(name="RiverWaterAvg2.findAll", query="SELECT r FROM RiverWaterAvg2 r")
public class RiverWaterAvg2 implements Serializable {
