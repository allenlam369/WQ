...
/**
 * The persistent class for the mt_seacat database table.
 * 
 */
@Entity
@Table(name="mt_seacat")
@NamedQuery(name="MtSeacat.findAll", query="SELECT m FROM MtSeacat m")
public class MtSeacat implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MtSeacatPK id;
	...
	public MtSeacatPK getId() {
		return this.id;
	}

	public void setId(MtSeacatPK id) {
		this.id = id;
	}
