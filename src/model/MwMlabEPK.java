...
/**
 * The primary key class for the mw_mlab_e database table.
 * 
 */
@Embeddable
public class MwMlabEPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MwMlabEPK)) {
			return false;
		}
		MwMlabEPK castOther = (MwMlabEPK)other;
		return 
