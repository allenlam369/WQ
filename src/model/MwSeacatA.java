...
/**
 * The persistent class for the mw_seacat_a database table.
 * 
 */
//@Entity
@Table(name="mw_seacat_a")
@NamedQuery(name="MwSeacatA.findAll", query="SELECT m FROM MwSeacatA m")
public class MwSeacatA implements Serializable {
