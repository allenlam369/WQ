...
/**
 * The persistent class for the mt_glabn database table.
 * 
 */
@Entity
@Table(name="mt_glabn")
@NamedQuery(name="MtGlabn.findAll", query="SELECT m FROM MtGlabn m")
public class MtGlabn implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MtGlabnPK id;
	...
	public MtGlabnPK getId() {
		return this.id;
	}

	public void setId(MtGlabnPK id) {
		this.id = id;
	}
