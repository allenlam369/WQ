...
/**
 * The persistent class for the rw_glabn_med_test database table.
 * 
 */
//@Entity
@Table(name="rw_glabn_med_test")
@NamedQuery(name="RwGlabnMedTest.findAll", query="SELECT r FROM RwGlabnMedTest r")
public class RwGlabnMedTest implements Serializable {
