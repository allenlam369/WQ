...
/**
 * The persistent class for the river_water_wqo_raw0 database table.
 * 
 */
//@Entity
@Table(name="river_water_wqo_raw0")
@NamedQuery(name="RiverWaterWqoRaw0.findAll", query="SELECT r FROM RiverWaterWqoRaw0 r")
public class RiverWaterWqoRaw0 implements Serializable {
	...
	@Column(name="meet_ec_5gm")
	private Integer meetEc5gm;

	@Column(name="meet_ec_5md")
	private Integer meetEc5md;
	...
	public Integer getMeetEc5gm() {
		return this.meetEc5gm;
	}

	public void setMeetEc5gm(Integer meetEc5gm) {
		this.meetEc5gm = meetEc5gm;
	}

	public Integer getMeetEc5md() {
		return this.meetEc5md;
	}

	public void setMeetEc5md(Integer meetEc5md) {
		this.meetEc5md = meetEc5md;
	}
