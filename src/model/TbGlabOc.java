...
/**
 * The persistent class for the tb_glab_oc database table.
 * 
 */
@Entity
@Table(name="tb_glab_oc")
@NamedQuery(name="TbGlabOc.findAll", query="SELECT t FROM TbGlabOc t")
public class TbGlabOc implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TbGlabOcPK id;
	...
	public TbGlabOcPK getId() {
		return this.id;
	}

	public void setId(TbGlabOcPK id) {
		this.id = id;
	}
