...
public class Mstation implements Serializable {
	...
	//bi-directional many-to-one association to MtVisit
	@OneToMany(mappedBy="mstation")
	private List<MtVisit> mtVisits;

	//bi-directional many-to-one association to MwVisit
	@OneToMany(mappedBy="mstation")
	private List<MwVisit> mwVisits;
	...
	public List<MtVisit> getMtVisits() {
		return this.mtVisits;
	}

	public void setMtVisits(List<MtVisit> mtVisits) {
		this.mtVisits = mtVisits;
	}

	public MtVisit addMtVisit(MtVisit mtVisit) {
		getMtVisits().add(mtVisit);
		mtVisit.setMstation(this);

		return mtVisit;
	}

	public MtVisit removeMtVisit(MtVisit mtVisit) {
		getMtVisits().remove(mtVisit);
		mtVisit.setMstation(null);

		return mtVisit;
	}

	public List<MwVisit> getMwVisits() {
		return this.mwVisits;
	}

	public void setMwVisits(List<MwVisit> mwVisits) {
		this.mwVisits = mwVisits;
	}

	public MwVisit addMwVisit(MwVisit mwVisit) {
		getMwVisits().add(mwVisit);
		mwVisit.setMstation(this);

		return mwVisit;
	}

	public MwVisit removeMwVisit(MwVisit mwVisit) {
		getMwVisits().remove(mwVisit);
		mwVisit.setMstation(null);
