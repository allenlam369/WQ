...
/**
 * The persistent class for the dioxin_sediment_x_avg1 database table.
 * 
 */
//@Entity
@Table(name="dioxin_sediment_x_avg1")
@NamedQuery(name="DioxinSedimentXAvg1.findAll", query="SELECT d FROM DioxinSedimentXAvg1 d")
public class DioxinSedimentXAvg1 implements Serializable {
