...
/**
 * The primary key class for the tw_glabm database table.
 * 
 */
@Embeddable
public class TwGlabmPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TwGlabmPK)) {
			return false;
		}
		TwGlabmPK castOther = (TwGlabmPK)other;
		return 
