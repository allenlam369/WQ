...
/**
 * The persistent class for the tw_glab_pah database table.
 * 
 */
@Entity
@Table(name="tw_glab_pah")
@NamedQuery(name="TwGlabPah.findAll", query="SELECT t FROM TwGlabPah t")
public class TwGlabPah implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TwGlabPahPK id;
	...
	public TwGlabPahPK getId() {
		return this.id;
	}

	public void setId(TwGlabPahPK id) {
		this.id = id;
	}
