...
/**
 * The persistent class for the mt_glabn_cal_aa database table.
 * 
 */
//@Entity
@Table(name="mt_glabn_cal_aa")
@NamedQuery(name="MtGlabnCalAa.findAll", query="SELECT m FROM MtGlabnCalAa m")
public class MtGlabnCalAa implements Serializable {
