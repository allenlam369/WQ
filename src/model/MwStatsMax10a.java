...
/**
 * The persistent class for the mw_stats_max10a database table.
 * 
 */
//@Entity
@Table(name="mw_stats_max10a")
@NamedQuery(name="MwStatsMax10a.findAll", query="SELECT m FROM MwStatsMax10a m")
public class MwStatsMax10a implements Serializable {
