...
/**
 * The persistent class for the tb_clab_dlpcb database table.
 * 
 */
@Entity
@Table(name="tb_clab_dlpcb")
@NamedQuery(name="TbClabDlpcb.findAll", query="SELECT t FROM TbClabDlpcb t")
public class TbClabDlpcb implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TbClabDlpcbPK id;
	...
	public TbClabDlpcbPK getId() {
		return this.id;
	}

	public void setId(TbClabDlpcbPK id) {
		this.id = id;
	}
