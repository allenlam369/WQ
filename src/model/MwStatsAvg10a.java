...
/**
 * The persistent class for the mw_stats_avg10a database table.
 * 
 */
//@Entity
@Table(name="mw_stats_avg10a")
@NamedQuery(name="MwStatsAvg10a.findAll", query="SELECT m FROM MwStatsAvg10a m")
public class MwStatsAvg10a implements Serializable {
