...
/**
 * The persistent class for the tb_clab_dlpcb_cal database table.
 * 
 */
//@Entity
@Table(name="tb_clab_dlpcb_cal")
@NamedQuery(name="TbClabDlpcbCal.findAll", query="SELECT t FROM TbClabDlpcbCal t")
public class TbClabDlpcbCal implements Serializable {
