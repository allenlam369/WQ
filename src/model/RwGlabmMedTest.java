...
/**
 * The persistent class for the rw_glabm_med_test database table.
 * 
 */
//@Entity
@Table(name="rw_glabm_med_test")
@NamedQuery(name="RwGlabmMedTest.findAll", query="SELECT r FROM RwGlabmMedTest r")
public class RwGlabmMedTest implements Serializable {
