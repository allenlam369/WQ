...
/**
 * The primary key class for the tb_clab_bu database table.
 * 
 */
@Embeddable
public class TbClabBuPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TbClabBuPK)) {
			return false;
		}
		TbClabBuPK castOther = (TbClabBuPK)other;
		return 
