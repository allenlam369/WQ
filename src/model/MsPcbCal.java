...
/**
 * The persistent class for the ms_pcb_cal database table.
 * 
 */
//@Entity
@Table(name="ms_pcb_cal")
@NamedQuery(name="MsPcbCal.findAll", query="SELECT m FROM MsPcbCal m")
public class MsPcbCal implements Serializable {
