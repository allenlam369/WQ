...
/**
 * The persistent class for the mw_sz_wqo database table.
 * 
 */
@Entity
@Table(name="mw_sz_wqo")
@NamedQuery(name="MwSzWqo.findAll", query="SELECT m FROM MwSzWqo m")
public class MwSzWqo implements Serializable {
