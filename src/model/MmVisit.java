...
/**
 * The persistent class for the mm_visit database table.
 * 
 */
@Entity
@Table(name="mm_visit")
@NamedQuery(name="MmVisit.findAll", query="SELECT m FROM MmVisit m")
public class MmVisit implements Serializable {
