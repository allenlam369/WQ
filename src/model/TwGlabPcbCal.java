...
/**
 * The persistent class for the tw_glab_pcb_cal database table.
 * 
 */
//@Entity
@Table(name="tw_glab_pcb_cal")
@NamedQuery(name="TwGlabPcbCal.findAll", query="SELECT t FROM TwGlabPcbCal t")
public class TwGlabPcbCal implements Serializable {
