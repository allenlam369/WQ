...
/**
 * The primary key class for the hs_glabn database table.
 * 
 */
@Embeddable
public class HsGlabnPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof HsGlabnPK)) {
			return false;
		}
		HsGlabnPK castOther = (HsGlabnPK)other;
		return 
