...
/**
 * The persistent class for the sr_mw_field database table.
 * 
 */
//@Entity
@Table(name="sr_mw_field")
@NamedQuery(name="SrMwField.findAll", query="SELECT s FROM SrMwField s")
public class SrMwField implements Serializable {
