...
/**
 * The persistent class for the toxic_water_pah1 database table.
 * 
 */
//@Entity
@Table(name="toxic_water_pah1")
@NamedQuery(name="ToxicWaterPah1.findAll", query="SELECT t FROM ToxicWaterPah1 t")
public class ToxicWaterPah1 implements Serializable {
