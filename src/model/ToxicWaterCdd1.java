...
/**
 * The persistent class for the toxic_water_cdd1 database table.
 * 
 */
//@Entity
@Table(name="toxic_water_cdd1")
@NamedQuery(name="ToxicWaterCdd1.findAll", query="SELECT t FROM ToxicWaterCdd1 t")
public class ToxicWaterCdd1 implements Serializable {
