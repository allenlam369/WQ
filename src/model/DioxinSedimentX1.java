...
/**
 * The persistent class for the dioxin_sediment_x1 database table.
 * 
 */
//@Entity
@Table(name="dioxin_sediment_x1")
@NamedQuery(name="DioxinSedimentX1.findAll", query="SELECT d FROM DioxinSedimentX1 d")
public class DioxinSedimentX1 implements Serializable {
