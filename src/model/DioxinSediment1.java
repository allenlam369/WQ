...
/**
 * The persistent class for the dioxin_sediment1 database table.
 * 
 */
//@Entity
@Table(name="dioxin_sediment1")
@NamedQuery(name="DioxinSediment1.findAll", query="SELECT d FROM DioxinSediment1 d")
public class DioxinSediment1 implements Serializable {
