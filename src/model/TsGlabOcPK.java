...
/**
 * The primary key class for the ts_glab_oc database table.
 * 
 */
@Embeddable
public class TsGlabOcPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TsGlabOcPK)) {
			return false;
		}
		TsGlabOcPK castOther = (TsGlabOcPK)other;
		return 
