...
/**
 * The primary key class for the mw_glabn database table.
 * 
 */
@Embeddable
public class MwGlabnPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MwGlabnPK)) {
			return false;
		}
		MwGlabnPK castOther = (MwGlabnPK)other;
		return 
