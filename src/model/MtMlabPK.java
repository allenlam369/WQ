...
/**
 * The primary key class for the mt_mlab database table.
 * 
 */
@Embeddable
public class MtMlabPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MtMlabPK)) {
			return false;
		}
		MtMlabPK castOther = (MtMlabPK)other;
		return 
