...
/**
 * The persistent class for the bm_visit_label_summary_c database table.
 * 
 */
//@Entity
@Table(name="bm_visit_label_summary_c")
@NamedQuery(name="BmVisitLabelSummaryC.findAll", query="SELECT b FROM BmVisitLabelSummaryC b")
public class BmVisitLabelSummaryC implements Serializable {
