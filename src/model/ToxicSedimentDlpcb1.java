...
/**
 * The persistent class for the toxic_sediment_dlpcb1 database table.
 * 
 */
//@Entity
@Table(name="toxic_sediment_dlpcb1")
@NamedQuery(name="ToxicSedimentDlpcb1.findAll", query="SELECT t FROM ToxicSedimentDlpcb1 t")
public class ToxicSedimentDlpcb1 implements Serializable {
