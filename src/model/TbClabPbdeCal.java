...
/**
 * The persistent class for the tb_clab_pbde_cal database table.
 * 
 */
//@Entity
@Table(name="tb_clab_pbde_cal")
@NamedQuery(name="TbClabPbdeCal.findAll", query="SELECT t FROM TbClabPbdeCal t")
public class TbClabPbdeCal implements Serializable {
