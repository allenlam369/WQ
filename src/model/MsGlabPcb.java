...
/**
 * The persistent class for the ms_glab_pcb database table.
 * 
 */
@Entity
@Table(name="ms_glab_pcb")
@NamedQuery(name="MsGlabPcb.findAll", query="SELECT m FROM MsGlabPcb m")
public class MsGlabPcb implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MsGlabPcbPK id;
	...
	public MsGlabPcbPK getId() {
		return this.id;
	}

	public void setId(MsGlabPcbPK id) {
		this.id = id;
	}
