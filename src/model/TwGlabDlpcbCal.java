...
/**
 * The persistent class for the tw_glab_dlpcb_cal database table.
 * 
 */
//@Entity
@Table(name="tw_glab_dlpcb_cal")
@NamedQuery(name="TwGlabDlpcbCal.findAll", query="SELECT t FROM TwGlabDlpcbCal t")
public class TwGlabDlpcbCal implements Serializable {
