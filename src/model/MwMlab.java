...
/**
 * The persistent class for the mw_mlab database table.
 * 
 */
@Entity
@Table(name="mw_mlab")
@NamedQuery(name="MwMlab.findAll", query="SELECT m FROM MwMlab m")
public class MwMlab implements Serializable {
	...
	public MwMlabPK getId() {
		return this.id;
	}

	public void setId(MwMlabPK id) {
		this.id = id;
	}
