...
/**
 * The persistent class for the ts_glab_pah_cal database table.
 * 
 */
//@Entity
@Table(name="ts_glab_pah_cal")
@NamedQuery(name="TsGlabPahCal.findAll", query="SELECT t FROM TsGlabPahCal t")
public class TsGlabPahCal implements Serializable {
