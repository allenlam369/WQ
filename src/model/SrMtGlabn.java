...
/**
 * The persistent class for the sr_mt_glabn database table.
 * 
 */
//@Entity
@Table(name="sr_mt_glabn")
@NamedQuery(name="SrMtGlabn.findAll", query="SELECT s FROM SrMtGlabn s")
public class SrMtGlabn implements Serializable {
