...
/**
 * The persistent class for the hs_mlab_aa database table.
 * 
 */
//@Entity
@Table(name="hs_mlab_aa")
@NamedQuery(name="HsMlabAa.findAll", query="SELECT h FROM HsMlabAa h")
public class HsMlabAa implements Serializable {
