...
/**
 * The persistent class for the bm_field database table.
 * 
 */
@Entity
@Table(name="bm_field")
@NamedQuery(name="BmField.findAll", query="SELECT b FROM BmField b")
public class BmField implements Serializable {
