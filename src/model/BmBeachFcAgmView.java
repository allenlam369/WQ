...
/**
 * The persistent class for the bm_beach_fc_agm_view database table.
 * 
 */
//@Entity
@Table(name="bm_beach_fc_agm_view")
@NamedQuery(name="BmBeachFcAgmView.findAll", query="SELECT b FROM BmBeachFcAgmView b")
public class BmBeachFcAgmView implements Serializable {
