...
/**
 * The persistent class for the mw_glabn_cal_aa database table.
 * 
 */
//@Entity
@Table(name="mw_glabn_cal_aa")
@NamedQuery(name="MwGlabnCalAa.findAll", query="SELECT m FROM MwGlabnCalAa m")
public class MwGlabnCalAa implements Serializable {
