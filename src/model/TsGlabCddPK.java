...
/**
 * The primary key class for the ts_glab_cdd database table.
 * 
 */
@Embeddable
public class TsGlabCddPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TsGlabCddPK)) {
			return false;
		}
		TsGlabCddPK castOther = (TsGlabCddPK)other;
		return 
