...
/**
 * The persistent class for the bm_rainfall_lst_check database table.
 * 
 */
//@Entity
@Table(name="bm_rainfall_lst_check")
@NamedQuery(name="BmRainfallLstCheck.findAll", query="SELECT b FROM BmRainfallLstCheck b")
public class BmRainfallLstCheck implements Serializable {
