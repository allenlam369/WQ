...
/**
 * The persistent class for the hs_seacat_a database table.
 * 
 */
//@Entity
@Table(name="hs_seacat_a")
@NamedQuery(name="HsSeacatA.findAll", query="SELECT h FROM HsSeacatA h")
public class HsSeacatA implements Serializable {
