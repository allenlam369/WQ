...
/**
 * The persistent class for the tw_clab database table.
 * 
 */
@Entity
@Table(name="tw_clab")
@NamedQuery(name="TwClab.findAll", query="SELECT t FROM TwClab t")
public class TwClab implements Serializable {
	...
	public TwClabPK getId() {
		return this.id;
	}

	public void setId(TwClabPK id) {
		this.id = id;
	}
