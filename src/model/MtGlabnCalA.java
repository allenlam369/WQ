...
/**
 * The persistent class for the mt_glabn_cal_a database table.
 * 
 */
//@Entity
@Table(name="mt_glabn_cal_a")
@NamedQuery(name="MtGlabnCalA.findAll", query="SELECT m FROM MtGlabnCalA m")
public class MtGlabnCalA implements Serializable {
