...
/**
 * The persistent class for the rs_glabm database table.
 * 
 */
@Entity
@Table(name="rs_glabm")
@NamedQuery(name="RsGlabm.findAll", query="SELECT r FROM RsGlabm r")
public class RsGlabm implements Serializable {
