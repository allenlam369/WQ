...
/**
 * The persistent class for the river_sediment1 database table.
 * 
 */
//@Entity
@Table(name="river_sediment1")
@NamedQuery(name="RiverSediment1.findAll", query="SELECT r FROM RiverSediment1 r")
public class RiverSediment1 implements Serializable {
