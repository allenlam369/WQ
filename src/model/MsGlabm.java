...
/**
 * The persistent class for the ms_glabm database table.
 * 
 */
@Entity
@Table(name="ms_glabm")
@NamedQuery(name="MsGlabm.findAll", query="SELECT m FROM MsGlabm m")
public class MsGlabm implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MsGlabmPK id;
	...
	public MsGlabmPK getId() {
		return this.id;
	}

	public void setId(MsGlabmPK id) {
		this.id = id;
	}
