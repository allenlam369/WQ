...
/**
 * The primary key class for the ts_clab_oc database table.
 * 
 */
@Embeddable
public class TsClabOcPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TsClabOcPK)) {
			return false;
		}
		TsClabOcPK castOther = (TsClabOcPK)other;
		return 
