...
/**
 * The persistent class for the bm_field_c_aux database table.
 * 
 */
@Entity
@Table(name="bm_field_c_aux")
@NamedQuery(name="BmFieldCAux.findAll", query="SELECT b FROM BmFieldCAux b")
public class BmFieldCAux implements Serializable {
