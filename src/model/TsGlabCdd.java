...
/**
 * The persistent class for the ts_glab_cdd database table.
 * 
 */
@Entity
@Table(name="ts_glab_cdd")
@NamedQuery(name="TsGlabCdd.findAll", query="SELECT t FROM TsGlabCdd t")
public class TsGlabCdd implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TsGlabCddPK id;
	...
	public TsGlabCddPK getId() {
		return this.id;
	}

	public void setId(TsGlabCddPK id) {
		this.id = id;
	}
