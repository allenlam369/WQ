...
/**
 * The persistent class for the marine_sediment_y1 database table.
 * 
 */
//@Entity
@Table(name="marine_sediment_y1")
@NamedQuery(name="MarineSedimentY1.findAll", query="SELECT m FROM MarineSedimentY1 m")
public class MarineSedimentY1 implements Serializable {
