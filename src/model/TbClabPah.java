...
/**
 * The persistent class for the tb_clab_pah database table.
 * 
 */
@Entity
@Table(name="tb_clab_pah")
@NamedQuery(name="TbClabPah.findAll", query="SELECT t FROM TbClabPah t")
public class TbClabPah implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TbClabPahPK id;
	...
	public TbClabPahPK getId() {
		return this.id;
	}

	public void setId(TbClabPahPK id) {
		this.id = id;
	}
