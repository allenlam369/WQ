...
/**
 * The persistent class for the sr_hs_field database table.
 * 
 */
//@Entity
@Table(name="sr_hs_field")
@NamedQuery(name="SrHsField.findAll", query="SELECT s FROM SrHsField s")
public class SrHsField implements Serializable {
