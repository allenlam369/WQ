...
/**
 * The persistent class for the rw_wqo_sum0 database table.
 * 
 */
//@Entity
@Table(name="rw_wqo_sum0")
@NamedQuery(name="RwWqoSum0.findAll", query="SELECT r FROM RwWqoSum0 r")
public class RwWqoSum0 implements Serializable {
