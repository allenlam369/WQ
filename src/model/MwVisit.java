...
/**
 * The persistent class for the mw_visit database table.
 * 
 */
@Entity
@Table(name="mw_visit")
@NamedQuery(name="MwVisit.findAll", query="SELECT m FROM MwVisit m")
public class MwVisit implements Serializable {
