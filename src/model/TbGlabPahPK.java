...
/**
 * The primary key class for the tb_glab_pah database table.
 * 
 */
@Embeddable
public class TbGlabPahPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TbGlabPahPK)) {
			return false;
		}
		TbGlabPahPK castOther = (TbGlabPahPK)other;
		return 
