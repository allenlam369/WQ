...
/**
 * The persistent class for the sr_bt_di database table.
 * 
 */
//@Entity
@Table(name="sr_bt_di")
@NamedQuery(name="SrBtDi.findAll", query="SELECT s FROM SrBtDi s")
public class SrBtDi implements Serializable {
	private static final long serialVersionUID = 1L;

	@Column(name="bt_di_id")
	private String btDiId;
	...
	public String getBtDiId() {
		return this.btDiId;
	}

	public void setBtDiId(String btDiId) {
		this.btDiId = btDiId;
	}
	...
	public BigDecimal getDwrDi() {
		return this.dwrDi;
	}

	public void setDwrDi(BigDecimal dwrDi) {
		this.dwrDi = dwrDi;
	}
