...
/**
 * The persistent class for the mw_statistics10a database table.
 * 
 */
//@Entity
@Table(name="mw_statistics10a")
@NamedQuery(name="MwStatistics10a.findAll", query="SELECT m FROM MwStatistics10a m")
public class MwStatistics10a implements Serializable {
