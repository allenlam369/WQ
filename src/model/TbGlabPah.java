...
/**
 * The persistent class for the tb_glab_pah database table.
 * 
 */
@Entity
@Table(name="tb_glab_pah")
@NamedQuery(name="TbGlabPah.findAll", query="SELECT t FROM TbGlabPah t")
public class TbGlabPah implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TbGlabPahPK id;
	...
	public TbGlabPahPK getId() {
		return this.id;
	}

	public void setId(TbGlabPahPK id) {
		this.id = id;
	}
