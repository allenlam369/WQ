...
/**
 * The persistent class for the rw_glabn_cal database table.
 * 
 */
//@Entity
@Table(name="rw_glabn_cal")
@NamedQuery(name="RwGlabnCal.findAll", query="SELECT r FROM RwGlabnCal r")
public class RwGlabnCal implements Serializable {
