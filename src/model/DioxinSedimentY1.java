...
/**
 * The persistent class for the dioxin_sediment_y1 database table.
 * 
 */
//@Entity
@Table(name="dioxin_sediment_y1")
@NamedQuery(name="DioxinSedimentY1.findAll", query="SELECT d FROM DioxinSedimentY1 d")
public class DioxinSedimentY1 implements Serializable {
