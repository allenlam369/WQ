...
/**
 * The primary key class for the mw_seacat_e database table.
 * 
 */
@Embeddable
public class MwSeacatEPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MwSeacatEPK)) {
			return false;
		}
		MwSeacatEPK castOther = (MwSeacatEPK)other;
		return 
