...
/**
 * The persistent class for the mw_other_e database table.
 * 
 */
//@Entity
@Table(name="mw_other_e")
@NamedQuery(name="MwOtherE.findAll", query="SELECT m FROM MwOtherE m")
public class MwOtherE implements Serializable {
