...
/**
 * The persistent class for the marine_water1_tmp1 database table.
 * 
 */
//@Entity
@Table(name="marine_water1_tmp1")
@NamedQuery(name="MarineWater1Tmp1.findAll", query="SELECT m FROM MarineWater1Tmp1 m")
public class MarineWater1Tmp1 implements Serializable {
