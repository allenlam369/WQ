...
/**
 * The persistent class for the bm_rain database table.
 * 
 */
@Entity
@Table(name = "bm_rain")
@NamedQuery(name = "BmRain.findAll", query = "SELECT b FROM BmRain b")
public class BmRain implements Serializable {
	...
	public String toString() {
		return "BmRain [beachCode=" + beachCode + ", bmvisitId=" + bmvisitId + ", id=" + id + ", rainStationCode="
				+ rainStationCode + ", rainfall=" + rainfall + ", rainfallLast12hr=" + rainfallLast12hr
				+ ", rainfallLast24hr=" + rainfallLast24hr + ", rainfallLast72hr=" + rainfallLast72hr
				+ ", rainfallMax3hr=" + rainfallMax3hr + ", rainfallMaxTime=" + rainfallMaxTime + ", riskRainLast12hr="
				+ riskRainLast12hr + ", riskRainLast24hr=" + riskRainLast24hr + ", riskRainLast72hr=" + riskRainLast72hr
				+ ", riskRainMax3hr=" + riskRainMax3hr + ", sdatetime=" + sdatetime + ", validCode=" + validCode
				+ ", validDate=" + validDate + ", validUser=" + validUser + "]";
	}
