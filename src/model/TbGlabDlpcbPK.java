...
/**
 * The primary key class for the tb_glab_dlpcb database table.
 * 
 */
@Embeddable
public class TbGlabDlpcbPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TbGlabDlpcbPK)) {
			return false;
		}
		TbGlabDlpcbPK castOther = (TbGlabDlpcbPK)other;
		return 
