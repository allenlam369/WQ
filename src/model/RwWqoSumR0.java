...
/**
 * The persistent class for the rw_wqo_sum_r0 database table.
 * 
 */
//@Entity
@Table(name="rw_wqo_sum_r0")
@NamedQuery(name="RwWqoSumR0.findAll", query="SELECT r FROM RwWqoSumR0 r")
public class RwWqoSumR0 implements Serializable {
