...
/**
 * The primary key class for the ts_clab database table.
 * 
 */
@Embeddable
public class TsClabPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TsClabPK)) {
			return false;
		}
		TsClabPK castOther = (TsClabPK)other;
		return 
