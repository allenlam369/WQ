...
/**
 * The primary key class for the mt_seacat database table.
 * 
 */
@Embeddable
public class MtSeacatPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MtSeacatPK)) {
			return false;
		}
		MtSeacatPK castOther = (MtSeacatPK)other;
		return 
