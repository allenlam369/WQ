...
/**
 * The persistent class for the marine_water_a2 database table.
 * 
 */
//@Entity
@Table(name="marine_water_a2")
@NamedQuery(name="MarineWaterA2.findAll", query="SELECT m FROM MarineWaterA2 m")
public class MarineWaterA2 implements Serializable {
