...
/**
 * The persistent class for the mw_stats_min10a database table.
 * 
 */
//@Entity
@Table(name="mw_stats_min10a")
@NamedQuery(name="MwStatsMin10a.findAll", query="SELECT m FROM MwStatsMin10a m")
public class MwStatsMin10a implements Serializable {
