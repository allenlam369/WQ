...
/**
 * The persistent class for the river_water_glabn1 database table.
 * 
 */
//@Entity
@Table(name="river_water_glabn1")
@NamedQuery(name="RiverWaterGlabn1.findAll", query="SELECT r FROM RiverWaterGlabn1 r")
public class RiverWaterGlabn1 implements Serializable {
