...
/**
 * The persistent class for the sr_mw_sz_wqo database table.
 * 
 */
//@Entity
@Table(name="sr_mw_sz_wqo")
@NamedQuery(name="SrMwSzWqo.findAll", query="SELECT s FROM SrMwSzWqo s")
public class SrMwSzWqo implements Serializable {
