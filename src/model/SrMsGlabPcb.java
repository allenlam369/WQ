...
/**
 * The persistent class for the sr_ms_glab_pcb database table.
 * 
 */
//@Entity
@Table(name="sr_ms_glab_pcb")
@NamedQuery(name="SrMsGlabPcb.findAll", query="SELECT s FROM SrMsGlabPcb s")
public class SrMsGlabPcb implements Serializable {
