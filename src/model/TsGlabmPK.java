...
/**
 * The primary key class for the ts_glabm database table.
 * 
 */
@Embeddable
public class TsGlabmPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TsGlabmPK)) {
			return false;
		}
		TsGlabmPK castOther = (TsGlabmPK)other;
		return 
