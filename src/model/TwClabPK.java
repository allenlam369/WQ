...
/**
 * The primary key class for the tw_clab database table.
 * 
 */
@Embeddable
public class TwClabPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TwClabPK)) {
			return false;
		}
		TwClabPK castOther = (TwClabPK)other;
		return 
