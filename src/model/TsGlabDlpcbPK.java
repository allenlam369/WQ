...
/**
 * The primary key class for the ts_glab_dlpcb database table.
 * 
 */
@Embeddable
public class TsGlabDlpcbPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TsGlabDlpcbPK)) {
			return false;
		}
		TsGlabDlpcbPK castOther = (TsGlabDlpcbPK)other;
		return 
