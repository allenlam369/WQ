...
/**
 * The persistent class for the tw_glab_pah_cal database table.
 * 
 */
//@Entity
@Table(name="tw_glab_pah_cal")
@NamedQuery(name="TwGlabPahCal.findAll", query="SELECT t FROM TwGlabPahCal t")
public class TwGlabPahCal implements Serializable {
