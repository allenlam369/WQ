...
/**
 * The persistent class for the sr_hs_mlab database table.
 * 
 */
//@Entity
@Table(name="sr_hs_mlab")
@NamedQuery(name="SrHsMlab.findAll", query="SELECT s FROM SrHsMlab s")
public class SrHsMlab implements Serializable {
