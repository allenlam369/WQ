...
/**
 * The primary key class for the ms_glab_oc database table.
 * 
 */
@Embeddable
public class MsGlabOcPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MsGlabOcPK)) {
			return false;
		}
		MsGlabOcPK castOther = (MsGlabOcPK)other;
		return 
