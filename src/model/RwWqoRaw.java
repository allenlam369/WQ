...
/**
 * The persistent class for the rw_wqo_raw database table.
 * 
 */
//@Entity
@Table(name="rw_wqo_raw")
@NamedQuery(name="RwWqoRaw.findAll", query="SELECT r FROM RwWqoRaw r")
public class RwWqoRaw implements Serializable {
