...
/**
 * The persistent class for the ts_glab_dlpcb database table.
 * 
 */
@Entity
@Table(name="ts_glab_dlpcb")
@NamedQuery(name="TsGlabDlpcb.findAll", query="SELECT t FROM TsGlabDlpcb t")
public class TsGlabDlpcb implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TsGlabDlpcbPK id;
	...
	public TsGlabDlpcbPK getId() {
		return this.id;
	}

	public void setId(TsGlabDlpcbPK id) {
		this.id = id;
	}
