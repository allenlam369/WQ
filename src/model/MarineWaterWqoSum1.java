...
/**
 * The persistent class for the marine_water_wqo_sum1 database table.
 * 
 */
//@Entity
@Table(name="marine_water_wqo_sum1")
@NamedQuery(name="MarineWaterWqoSum1.findAll", query="SELECT m FROM MarineWaterWqoSum1 m")
public class MarineWaterWqoSum1 implements Serializable {
