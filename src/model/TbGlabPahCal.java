...
/**
 * The persistent class for the tb_glab_pah_cal database table.
 * 
 */
//@Entity
@Table(name="tb_glab_pah_cal")
@NamedQuery(name="TbGlabPahCal.findAll", query="SELECT t FROM TbGlabPahCal t")
public class TbGlabPahCal implements Serializable {
	...
	public void setPfoa(String pfoa) {
		this.pfoa = pfoa;
	}
	...
	public void setPfos(String pfos) {
		this.pfos = pfos;
	}
