...
/**
 * The primary key class for the tw_glab_dlpcb database table.
 * 
 */
@Embeddable
public class TwGlabDlpcbPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TwGlabDlpcbPK)) {
			return false;
		}
		TwGlabDlpcbPK castOther = (TwGlabDlpcbPK)other;
		return 
