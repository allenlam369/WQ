...
/**
 * The persistent class for the eutrophication database table.
 * 
 */
//@Entity
@NamedQuery(name="Eutrophication.findAll", query="SELECT e FROM Eutrophication e")
public class Eutrophication implements Serializable {
