...
/**
 * The persistent class for the bm_visit_c database table.
 * 
 */
@Entity
@Table(name="bm_visit_c")
@NamedQuery(name="BmVisitC.findAll", query="SELECT b FROM BmVisitC b")
public class BmVisitC implements Serializable {
