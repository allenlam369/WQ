...
/**
 * The persistent class for the sr_mt_seacat database table.
 * 
 */
//@Entity
@Table(name="sr_mt_seacat")
@NamedQuery(name="SrMtSeacat.findAll", query="SELECT s FROM SrMtSeacat s")
public class SrMtSeacat implements Serializable {
