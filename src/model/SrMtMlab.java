...
/**
 * The persistent class for the sr_mt_mlab database table.
 * 
 */
//@Entity
@Table(name="sr_mt_mlab")
@NamedQuery(name="SrMtMlab.findAll", query="SELECT s FROM SrMtMlab s")
public class SrMtMlab implements Serializable {
