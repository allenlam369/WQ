...
/**
 * The primary key class for the mt_other database table.
 * 
 */
@Embeddable
public class MtOtherPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MtOtherPK)) {
			return false;
		}
		MtOtherPK castOther = (MtOtherPK)other;
		return 
