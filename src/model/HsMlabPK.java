...
/**
 * The primary key class for the hs_mlab database table.
 * 
 */
@Embeddable
public class HsMlabPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof HsMlabPK)) {
			return false;
		}
		HsMlabPK castOther = (HsMlabPK)other;
		return 
