...
/**
 * The persistent class for the sr_ms_glab_oc database table.
 * 
 */
//@Entity
@Table(name="sr_ms_glab_oc")
@NamedQuery(name="SrMsGlabOc.findAll", query="SELECT s FROM SrMsGlabOc s")
public class SrMsGlabOc implements Serializable {
