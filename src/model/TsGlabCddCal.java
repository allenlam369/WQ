...
/**
 * The persistent class for the ts_glab_cdd_cal database table.
 * 
 */
//@Entity
@Table(name="ts_glab_cdd_cal")
@NamedQuery(name="TsGlabCddCal.findAll", query="SELECT t FROM TsGlabCddCal t")
public class TsGlabCddCal implements Serializable {
