...
/**
 * The primary key class for the tb_clab_pbde database table.
 * 
 */
@Embeddable
public class TbClabPbdePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TbClabPbdePK)) {
			return false;
		}
		TbClabPbdePK castOther = (TbClabPbdePK)other;
		return 
