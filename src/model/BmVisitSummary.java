...
/**
 * The persistent class for the bm_visit_summary database table.
 * 
 */
//@Entity
@Table(name="bm_visit_summary")
@NamedQuery(name="BmVisitSummary.findAll", query="SELECT b FROM BmVisitSummary b")
public class BmVisitSummary implements Serializable {
