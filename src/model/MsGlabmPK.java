...
/**
 * The primary key class for the ms_glabm database table.
 * 
 */
@Embeddable
public class MsGlabmPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MsGlabmPK)) {
			return false;
		}
		MsGlabmPK castOther = (MsGlabmPK)other;
		return 
