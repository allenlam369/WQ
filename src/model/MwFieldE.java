...
/**
 * The persistent class for the mw_field_e database table.
 * 
 */
@Entity
@Table(name="mw_field_e")
@NamedQuery(name="MwFieldE.findAll", query="SELECT m FROM MwFieldE m")
public class MwFieldE implements Serializable {
