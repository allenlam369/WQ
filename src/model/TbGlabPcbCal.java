...
/**
 * The persistent class for the tb_glab_pcb_cal database table.
 * 
 */
//@Entity
@Table(name="tb_glab_pcb_cal")
@NamedQuery(name="TbGlabPcbCal.findAll", query="SELECT t FROM TbGlabPcbCal t")
public class TbGlabPcbCal implements Serializable {
