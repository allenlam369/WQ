...
/**
 * The persistent class for the marine_sediment_pcb1 database table.
 * 
 */
//@Entity
@Table(name="marine_sediment_pcb1")
@NamedQuery(name="MarineSedimentPcb1.findAll", query="SELECT m FROM MarineSedimentPcb1 m")
public class MarineSedimentPcb1 implements Serializable {
