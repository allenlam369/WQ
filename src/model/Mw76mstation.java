...
/**
 * The persistent class for the mw_76mstation database table.
 * 
 */
//@Entity
@Table(name="mw_76mstation")
@NamedQuery(name="Mw76mstation.findAll", query="SELECT m FROM Mw76mstation m")
public class Mw76mstation implements Serializable {
