...
/**
 * The persistent class for the marine_water_statistics database table.
 * 
 */
//@Entity
@Table(name="marine_water_statistics")
@NamedQuery(name="MarineWaterStatistic.findAll", query="SELECT m FROM MarineWaterStatistic m")
public class MarineWaterStatistic implements Serializable {
