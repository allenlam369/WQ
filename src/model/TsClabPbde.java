...
/**
 * The persistent class for the ts_clab_pbde database table.
 * 
 */
@Entity
@Table(name="ts_clab_pbde")
@NamedQuery(name="TsClabPbde.findAll", query="SELECT t FROM TsClabPbde t")
public class TsClabPbde implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TsClabPbdePK id;
	...
	public TsClabPbdePK getId() {
		return this.id;
	}

	public void setId(TsClabPbdePK id) {
		this.id = id;
	}
