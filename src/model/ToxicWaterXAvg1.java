...
/**
 * The persistent class for the toxic_water_x_avg1 database table.
 * 
 */
//@Entity
@Table(name="toxic_water_x_avg1")
@NamedQuery(name="ToxicWaterXAvg1.findAll", query="SELECT t FROM ToxicWaterXAvg1 t")
public class ToxicWaterXAvg1 implements Serializable {
