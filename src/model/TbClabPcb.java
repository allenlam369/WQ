...
/**
 * The persistent class for the tb_clab_pcb database table.
 * 
 */
@Entity
@Table(name="tb_clab_pcb")
@NamedQuery(name="TbClabPcb.findAll", query="SELECT t FROM TbClabPcb t")
public class TbClabPcb implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TbClabPcbPK id;
	...
	public TbClabPcbPK getId() {
		return this.id;
	}

	public void setId(TbClabPcbPK id) {
		this.id = id;
	}
