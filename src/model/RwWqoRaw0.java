...
/**
 * The persistent class for the rw_wqo_raw0 database table.
 * 
 */
//@Entity
@Table(name="rw_wqo_raw0")
@NamedQuery(name="RwWqoRaw0.findAll", query="SELECT r FROM RwWqoRaw0 r")
public class RwWqoRaw0 implements Serializable {
