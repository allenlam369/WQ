...
/**
 * The persistent class for the mt_mlab_aa database table.
 * 
 */
//@Entity
@Table(name="mt_mlab_aa")
@NamedQuery(name="MtMlabAa.findAll", query="SELECT m FROM MtMlabAa m")
public class MtMlabAa implements Serializable {
