...
/**
 * The persistent class for the sr_rw_glabm database table.
 * 
 */
//@Entity
@Table(name="sr_rw_glabm")
@NamedQuery(name="SrRwGlabm.findAll", query="SELECT s FROM SrRwGlabm s")
public class SrRwGlabm implements Serializable {
