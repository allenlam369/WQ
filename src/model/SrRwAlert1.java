...
/**
 * The persistent class for the sr_rw_alert1 database table.
 * 
 */
//@Entity
@Table(name="sr_rw_alert1")
@NamedQuery(name="SrRwAlert1.findAll", query="SELECT s FROM SrRwAlert1 s")
public class SrRwAlert1 implements Serializable {
