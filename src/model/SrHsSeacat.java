...
/**
 * The persistent class for the sr_hs_seacat database table.
 * 
 */
//@Entity
@Table(name="sr_hs_seacat")
@NamedQuery(name="SrHsSeacat.findAll", query="SELECT s FROM SrHsSeacat s")
public class SrHsSeacat implements Serializable {
