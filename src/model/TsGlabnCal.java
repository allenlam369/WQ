...
/**
 * The persistent class for the ts_glabn_cal database table.
 * 
 */
//@Entity
@Table(name="ts_glabn_cal")
@NamedQuery(name="TsGlabnCal.findAll", query="SELECT t FROM TsGlabnCal t")
public class TsGlabnCal implements Serializable {
