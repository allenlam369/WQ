...
/**
 * The persistent class for the mt_other database table.
 * 
 */
@Entity
@Table(name="mt_other")
@NamedQuery(name="MtOther.findAll", query="SELECT m FROM MtOther m")
public class MtOther implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MtOtherPK id;
	...
	public MtOtherPK getId() {
		return this.id;
	}

	public void setId(MtOtherPK id) {
		this.id = id;
	}
