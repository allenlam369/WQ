...
/**
 * The persistent class for the hs_glabn database table.
 * 
 */
@Entity
@Table(name="hs_glabn")
@NamedQuery(name="HsGlabn.findAll", query="SELECT h FROM HsGlabn h")
public class HsGlabn implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private HsGlabnPK id;
	...
	public HsGlabnPK getId() {
		return this.id;
	}

	public void setId(HsGlabnPK id) {
		this.id = id;
	}
