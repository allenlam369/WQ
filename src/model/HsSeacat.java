...
/**
 * The persistent class for the hs_seacat database table.
 * 
 */
@Entity
@Table(name="hs_seacat")
@NamedQuery(name="HsSeacat.findAll", query="SELECT h FROM HsSeacat h")
public class HsSeacat implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private HsSeacatPK id;
	...
	public HsSeacatPK getId() {
		return this.id;
	}

	public void setId(HsSeacatPK id) {
		this.id = id;
	}
