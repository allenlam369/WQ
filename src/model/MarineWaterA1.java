...
/**
 * The persistent class for the marine_water_a1 database table.
 * 
 */
//@Entity
@Table(name="marine_water_a1")
@NamedQuery(name="MarineWaterA1.findAll", query="SELECT m FROM MarineWaterA1 m")
public class MarineWaterA1 implements Serializable {
