...
/**
 * The persistent class for the rw_stats_min10a database table.
 * 
 */
//@Entity
@Table(name="rw_stats_min10a")
@NamedQuery(name="RwStatsMin10a.findAll", query="SELECT r FROM RwStatsMin10a r")
public class RwStatsMin10a implements Serializable {
