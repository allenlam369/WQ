...
/**
 * The primary key class for the mw_other database table.
 * 
 */
@Embeddable
public class MwOtherPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MwOtherPK)) {
			return false;
		}
		MwOtherPK castOther = (MwOtherPK)other;
		return 
