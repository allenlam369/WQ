...
/**
 * The persistent class for the sr_mm_glabm database table.
 * 
 */
//@Entity
@Table(name="sr_mm_glabm")
@NamedQuery(name="SrMmGlabm.findAll", query="SELECT s FROM SrMmGlabm s")
public class SrMmGlabm implements Serializable {
