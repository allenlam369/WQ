...
/**
 * The persistent class for the sr_hs_visit database table.
 * 
 */
//@Entity
@Table(name="sr_hs_visit")
@NamedQuery(name="SrHsVisit.findAll", query="SELECT s FROM SrHsVisit s")
public class SrHsVisit implements Serializable {
