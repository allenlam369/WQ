...
/**
 * The persistent class for the marine_water_seacat2 database table.
 * 
 */
//@Entity
@Table(name="marine_water_seacat2")
@NamedQuery(name="MarineWaterSeacat2.findAll", query="SELECT m FROM MarineWaterSeacat2 m")
public class MarineWaterSeacat2 implements Serializable {
