...
public class TenZone implements Serializable {
	...
	@OneToMany(mappedBy="tenZone")
	private List<WpcoWcz> wpcoWczs;
	...
	public List<WpcoWcz> getWpcoWczs() {
		return this.wpcoWczs;
	}

	public void setWpcoWczs(List<WpcoWcz> wpcoWczs) {
		this.wpcoWczs = wpcoWczs;
	}

	public WpcoWcz addWpcoWcz(WpcoWcz wpcoWcz) {
		getWpcoWczs().add(wpcoWcz);
		wpcoWcz.setTenZone(this);

		return wpcoWcz;
	}

	public WpcoWcz removeWpcoWcz(WpcoWcz wpcoWcz) {
		getWpcoWczs().remove(wpcoWcz);
		wpcoWcz.setTenZone(null);
