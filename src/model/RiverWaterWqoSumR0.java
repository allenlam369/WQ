...
/**
 * The persistent class for the river_water_wqo_sum_r0 database table.
 * 
 */
//@Entity
@Table(name="river_water_wqo_sum_r0")
@NamedQuery(name="RiverWaterWqoSumR0.findAll", query="SELECT r FROM RiverWaterWqoSumR0 r")
public class RiverWaterWqoSumR0 implements Serializable {
