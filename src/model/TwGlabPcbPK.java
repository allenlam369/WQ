...
/**
 * The primary key class for the tw_glab_pcb database table.
 * 
 */
@Embeddable
public class TwGlabPcbPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TwGlabPcbPK)) {
			return false;
		}
		TwGlabPcbPK castOther = (TwGlabPcbPK)other;
		return 
