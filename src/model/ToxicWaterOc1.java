...
/**
 * The persistent class for the toxic_water_oc1 database table.
 * 
 */
//@Entity
@Table(name="toxic_water_oc1")
@NamedQuery(name="ToxicWaterOc1.findAll", query="SELECT t FROM ToxicWaterOc1 t")
public class ToxicWaterOc1 implements Serializable {
