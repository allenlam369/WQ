...
/**
 * The persistent class for the marine_water_glabn1 database table.
 * 
 */
//@Entity
@Table(name="marine_water_glabn1")
@NamedQuery(name="MarineWaterGlabn1.findAll", query="SELECT m FROM MarineWaterGlabn1 m")
public class MarineWaterGlabn1 implements Serializable {
