...
/**
 * The persistent class for the sr_hs_glabn database table.
 * 
 */
//@Entity
@Table(name="sr_hs_glabn")
@NamedQuery(name="SrHsGlabn.findAll", query="SELECT s FROM SrHsGlabn s")
public class SrHsGlabn implements Serializable {
