...
/**
 * The persistent class for the tw_clab_dlpcb database table.
 * 
 */
@Entity
@Table(name="tw_clab_dlpcb")
@NamedQuery(name="TwClabDlpcb.findAll", query="SELECT t FROM TwClabDlpcb t")
public class TwClabDlpcb implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TwClabDlpcbPK id;
	...
	public TwClabDlpcbPK getId() {
		return this.id;
	}

	public void setId(TwClabDlpcbPK id) {
		this.id = id;
	}
