...
/**
 * The persistent class for the mw_seacat database table.
 * 
 */
@Entity
@Table(name="mw_seacat")
@NamedQuery(name="MwSeacat.findAll", query="SELECT m FROM MwSeacat m")
public class MwSeacat implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MwSeacatPK id;
	...
	public MwSeacatPK getId() {
		return this.id;
	}

	public void setId(MwSeacatPK id) {
		this.id = id;
	}
