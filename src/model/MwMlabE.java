...
/**
 * The persistent class for the mw_mlab_e database table.
 * 
 */
@Entity
@Table(name="mw_mlab_e")
@NamedQuery(name="MwMlabE.findAll", query="SELECT m FROM MwMlabE m")
public class MwMlabE implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MwMlabEPK id;
	...
	public MwMlabEPK getId() {
		return this.id;
	}

	public void setId(MwMlabEPK id) {
		this.id = id;
	}
