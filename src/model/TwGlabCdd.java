...
/**
 * The persistent class for the tw_glab_cdd database table.
 * 
 */
@Entity
@Table(name="tw_glab_cdd")
@NamedQuery(name="TwGlabCdd.findAll", query="SELECT t FROM TwGlabCdd t")
public class TwGlabCdd implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TwGlabCddPK id;
	...
	public TwGlabCddPK getId() {
		return this.id;
	}

	public void setId(TwGlabCddPK id) {
		this.id = id;
	}
