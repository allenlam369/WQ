...
/**
 * The persistent class for the tw_clab_pbde database table.
 * 
 */
@Entity
@Table(name="tw_clab_pbde")
@NamedQuery(name="TwClabPbde.findAll", query="SELECT t FROM TwClabPbde t")
public class TwClabPbde implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TwClabPbdePK id;
	...
	public TwClabPbdePK getId() {
		return this.id;
	}

	public void setId(TwClabPbdePK id) {
		this.id = id;
	}
	...
	public String getLPbde() {
		return this.lPbde;
	}

	public void setLPbde(String lPbde) {
		this.lPbde = lPbde;
	}
