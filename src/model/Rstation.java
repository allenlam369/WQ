...
public class Rstation implements Serializable {
	...
	//bi-directional many-to-one association to River
	@ManyToOne
	@JoinColumn(name="r_id")
	private River river;

	//bi-directional many-to-one association to RwVisit
	@OneToMany(mappedBy="rstation")
	private List<RwVisit> rwVisits;
	...
	public List<RwVisit> getRwVisits() {
		return this.rwVisits;
	}

	public void setRwVisits(List<RwVisit> rwVisits) {
		this.rwVisits = rwVisits;
	}

	public RwVisit addRwVisit(RwVisit rwVisit) {
		getRwVisits().add(rwVisit);
		rwVisit.setRstation(this);

		return rwVisit;
	}

	public RwVisit removeRwVisit(RwVisit rwVisit) {
		getRwVisits().remove(rwVisit);
		rwVisit.setRstation(null);
