...
/**
 * The persistent class for the rw_wqo_sum_r1 database table.
 * 
 */
//@Entity
@Table(name="rw_wqo_sum_r1")
@NamedQuery(name="RwWqoSumR1.findAll", query="SELECT r FROM RwWqoSumR1 r")
public class RwWqoSumR1 implements Serializable {
