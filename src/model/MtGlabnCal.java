...
/**
 * The persistent class for the mt_glabn_cal database table.
 * 
 */
//@Entity
@Table(name="mt_glabn_cal")
@NamedQuery(name="MtGlabnCal.findAll", query="SELECT m FROM MtGlabnCal m")
public class MtGlabnCal implements Serializable {
