...
/**
 * The persistent class for the rw_stats_max10a database table.
 * 
 */
//@Entity
@Table(name="rw_stats_max10a")
@NamedQuery(name="RwStatsMax10a.findAll", query="SELECT r FROM RwStatsMax10a r")
public class RwStatsMax10a implements Serializable {
