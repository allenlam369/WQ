...
/**
 * The persistent class for the rw_statistics10a database table.
 * 
 */
//@Entity
@Table(name="rw_statistics10a")
@NamedQuery(name="RwStatistics10a.findAll", query="SELECT r FROM RwStatistics10a r")
public class RwStatistics10a implements Serializable {
