...
/**
 * The persistent class for the tw_glab_dlpcb database table.
 * 
 */
@Entity
@Table(name="tw_glab_dlpcb")
@NamedQuery(name="TwGlabDlpcb.findAll", query="SELECT t FROM TwGlabDlpcb t")
public class TwGlabDlpcb implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TwGlabDlpcbPK id;
	...
	public TwGlabDlpcbPK getId() {
		return this.id;
	}

	public void setId(TwGlabDlpcbPK id) {
		this.id = id;
	}
