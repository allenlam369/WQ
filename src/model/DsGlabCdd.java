...
/**
 * The persistent class for the ds_glab_cdd database table.
 * 
 */
@Entity
@Table(name="ds_glab_cdd")
@NamedQuery(name="DsGlabCdd.findAll", query="SELECT d FROM DsGlabCdd d")
public class DsGlabCdd implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private DsGlabCddPK id;
	...
	public DsGlabCddPK getId() {
		return this.id;
	}

	public void setId(DsGlabCddPK id) {
		this.id = id;
	}
