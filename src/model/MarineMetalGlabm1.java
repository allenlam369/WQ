...
/**
 * The persistent class for the marine_metal_glabm1 database table.
 * 
 */
//@Entity
@Table(name="marine_metal_glabm1")
@NamedQuery(name="MarineMetalGlabm1.findAll", query="SELECT m FROM MarineMetalGlabm1 m")
public class MarineMetalGlabm1 implements Serializable {
