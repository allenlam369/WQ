...
/**
 * The persistent class for the toxic_water2 database table.
 * 
 */
//@Entity
@Table(name="toxic_water2")
@NamedQuery(name="ToxicWater2.findAll", query="SELECT t FROM ToxicWater2 t")
public class ToxicWater2 implements Serializable {
