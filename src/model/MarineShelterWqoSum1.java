...
/**
 * The persistent class for the marine_shelter_wqo_sum1 database table.
 * 
 */
//@Entity
@Table(name="marine_shelter_wqo_sum1")
@NamedQuery(name="MarineShelterWqoSum1.findAll", query="SELECT m FROM MarineShelterWqoSum1 m")
public class MarineShelterWqoSum1 implements Serializable {
