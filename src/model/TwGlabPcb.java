...
/**
 * The persistent class for the tw_glab_pcb database table.
 * 
 */
@Entity
@Table(name="tw_glab_pcb")
@NamedQuery(name="TwGlabPcb.findAll", query="SELECT t FROM TwGlabPcb t")
public class TwGlabPcb implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TwGlabPcbPK id;
	...
	public TwGlabPcbPK getId() {
		return this.id;
	}

	public void setId(TwGlabPcbPK id) {
		this.id = id;
	}
