...
/**
 * The persistent class for the ts_glab_pcb database table.
 * 
 */
@Entity
@Table(name="ts_glab_pcb")
@NamedQuery(name="TsGlabPcb.findAll", query="SELECT t FROM TsGlabPcb t")
public class TsGlabPcb implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TsGlabPcbPK id;
	...
	public TsGlabPcbPK getId() {
		return this.id;
	}

	public void setId(TsGlabPcbPK id) {
		this.id = id;
	}
