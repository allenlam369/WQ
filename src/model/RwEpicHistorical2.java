...
/**
 * The persistent class for the rw_epic_historical2 database table.
 * 
 */
//@Entity
@Table(name="rw_epic_historical2")
@NamedQuery(name="RwEpicHistorical2.findAll", query="SELECT r FROM RwEpicHistorical2 r")
public class RwEpicHistorical2 implements Serializable {
