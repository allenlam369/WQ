...
/**
 * The persistent class for the hs_glabn_cal_a database table.
 * 
 */
//@Entity
@Table(name="hs_glabn_cal_a")
@NamedQuery(name="HsGlabnCalA.findAll", query="SELECT h FROM HsGlabnCalA h")
public class HsGlabnCalA implements Serializable {
