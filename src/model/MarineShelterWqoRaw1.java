...
/**
 * The persistent class for the marine_shelter_wqo_raw1 database table.
 * 
 */
//@Entity
@Table(name="marine_shelter_wqo_raw1")
@NamedQuery(name="MarineShelterWqoRaw1.findAll", query="SELECT m FROM MarineShelterWqoRaw1 m")
public class MarineShelterWqoRaw1 implements Serializable {
