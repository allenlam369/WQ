...
/**
 * The persistent class for the bm_tide2 database table.
 * 
 */
//@Entity
@Table(name="bm_tide2")
@NamedQuery(name="BmTide2.findAll", query="SELECT b FROM BmTide2 b")
public class BmTide2 implements Serializable {
