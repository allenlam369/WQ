...
/**
 * The persistent class for the tb_clab_cdd_cal database table.
 * 
 */
//@Entity
@Table(name="tb_clab_cdd_cal")
@NamedQuery(name="TbClabCddCal.findAll", query="SELECT t FROM TbClabCddCal t")
public class TbClabCddCal implements Serializable {
